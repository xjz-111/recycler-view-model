...
public class RefreshFooterVm extends BaseCommonViewModel<Footer> {
...
//            notifyDataSetChanged();
    ...
    @Override
    protected void initView(@NonNull ViewDataBinding binding, @NonNull Footer footer, int position, List<Object> payloads) {
